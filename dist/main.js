...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#project{\n    display: flex;\n    flex-direction: column;\n    padding: 10px;\n    gap: 10px;\n}", "",{"version":3,"sources":["webpack://./src/project.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,sBAAsB;IACtB,aAAa;IACb,SAAS;AACb","sourcesContent":["#project{\n    display: flex;\n    flex-direction: column;\n    padding: 10px;\n    gap: 10px;\n}"],"sourceRoot":""}]);
// Exports
...
const toDoItem = (title, dueDate, priority) => {
    ...
    const getTheDate = () => {
        let placeholder = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(divGetDueDate.value);
        let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(placeholder, "MM/dd/yyyy");
...
const task = (0,_projects__WEBPACK_IMPORTED_MODULE_1__.project)();
const thing = (0,_toDoItems__WEBPACK_IMPORTED_MODULE_0__.toDoItem)("wassaauasssdp", "wassup","important");
const thing2 = (0,_toDoItems__WEBPACK_IMPORTED_MODULE_0__.toDoItem)("wassaassssasdup","wassup","important");

let ate = (0,_projects__WEBPACK_IMPORTED_MODULE_1__.project)();
ate.addToList(thing);
