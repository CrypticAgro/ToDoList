...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#project{\n    display: flex;\n    flex-direction: column;\n    padding: 10px;\n    gap: 10px;\n}\n#project-add{\n    width: 88vw;\n    height: 3vh;\n    display: flex;\n    justify-content: end;\n}\n#project-button-adder{\n    position: absolute;\n    top: 87%;\n    left: 2.5%;\n    background-color: #d63b3f;\n    border: none;\n    border-radius: 50px;\n    color: white;\n    width: 5%;\n    height: 10%;\n    cursor: pointer;\n    font-weight: bold;\n    font-size: 300%;\n}\n\n.project-names{\n    cursor: pointer;\n}", "",{"version":3,"sources":["webpack://./src/project.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,sBAAsB;IACtB,aAAa;IACb,SAAS;AACb;AACA;IACI,WAAW;IACX,WAAW;IACX,aAAa;IACb,oBAAoB;AACxB;AACA;IACI,kBAAkB;IAClB,QAAQ;IACR,UAAU;IACV,yBAAyB;IACzB,YAAY;IACZ,mBAAmB;IACnB,YAAY;IACZ,SAAS;IACT,WAAW;IACX,eAAe;IACf,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,eAAe;AACnB","sourcesContent":["#project{\n    display: flex;\n    flex-direction: column;\n    padding: 10px;\n    gap: 10px;\n}\n#project-add{\n    width: 88vw;\n    height: 3vh;\n    display: flex;\n    justify-content: end;\n}\n#project-button-adder{\n    position: absolute;\n    top: 87%;\n    left: 2.5%;\n    background-color: #d63b3f;\n    border: none;\n    border-radius: 50px;\n    color: white;\n    width: 5%;\n    height: 10%;\n    cursor: pointer;\n    font-weight: bold;\n    font-size: 300%;\n}\n\n.project-names{\n    cursor: pointer;\n}"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#container{\n    display: flex;\n    background-color: #d63b3f;\n    align-items: center;\n    gap: 20px;\n    width: 50vw;\n}\n#title{\n    color: white;\n}\n#due-date{\n    color: white;\n    cursor: pointer;\n}\n#subcontainer{\n    display: flex;\n    flex: 1;\n    justify-content: end;\n    gap: 20px;\n    padding-right: 15px;\n}", "",{"version":3,"sources":["webpack://./src/toDoItems.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,yBAAyB;IACzB,mBAAmB;IACnB,SAAS;IACT,WAAW;AACf;AACA;IACI,YAAY;AAChB;AACA;IACI,YAAY;IACZ,eAAe;AACnB;AACA;IACI,aAAa;IACb,OAAO;IACP,oBAAoB;IACpB,SAAS;IACT,mBAAmB;AACvB","sourcesContent":["#container{\n    display: flex;\n    background-color: #d63b3f;\n    align-items: center;\n    gap: 20px;\n    width: 50vw;\n}\n#title{\n    color: white;\n}\n#due-date{\n    color: white;\n    cursor: pointer;\n}\n#subcontainer{\n    display: flex;\n    flex: 1;\n    justify-content: end;\n    gap: 20px;\n    padding-right: 15px;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addToInbox": () => (/* binding */ addToInbox),
...
const addToToday = (item, time) => {
    let placeholder = (0,_toDoItems__WEBPACK_IMPORTED_MODULE_0__.toDoItem)(item.title, time , item.priority, item.description);
...
let inbox = (0,_projects__WEBPACK_IMPORTED_MODULE_0__.project)("Inbox");
let today = (0,_projects__WEBPACK_IMPORTED_MODULE_0__.project)("Today");
let week = (0,_projects__WEBPACK_IMPORTED_MODULE_0__.project)("Week");
...
addDivButton.addEventListener("click", () => (0,_projectForm__WEBPACK_IMPORTED_MODULE_2__.projectForm)());
...
const addTheItems = (item, projectOrTask, time) => {
    if(projectOrTask == "project"){
        ...
        if(item.today == true){
            ...
            let placeholderThree = (0,_dateCheck__WEBPACK_IMPORTED_MODULE_3__.addToInbox)(item, time);
            ...
            let placeholderTwo = (0,_dateCheck__WEBPACK_IMPORTED_MODULE_3__.addToInbox)(item, time);
            inbox.addToList(placeholderTwo);
        }
        else if(currentProject == inbox){
            currentProject.removeFromList(item);
            let placeholder = (0,_toDoItems__WEBPACK_IMPORTED_MODULE_4__.toDoItem)(item.title, time , item.priority, item.description);
            inbox.addToList(placeholder);
        }
        else{
            item.duplicated = true;
            console.log(item)
            let placeholder = (0,_dateCheck__WEBPACK_IMPORTED_MODULE_3__.addToInbox)(item, time);
            inbox.addToList(placeholder);
        }
...
const toDoItem = (title, dueDate, priority, description) => {
    ...
    const getTheDate = () => {
        ...
        let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(placeholder, "MM/dd/yyyy");
        divDueDate.innerText = formattedDate;
        divDueDate.addEventListener('click', addGetDueDate);
        if (duplicated == true){
        (0,_dateCheck__WEBPACK_IMPORTED_MODULE_1__.checkTheDate)(dueDate, formattedDate);
        }
    ...
    if (dueDate == undefined || dueDate == ""){
        ...
        let placeholder = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dueDate);
        formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(placeholder, "MM/dd/yyyy");
        divDueDate.innerText = formattedDate;
    }
    
    if(formattedDate == (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "MM/dd/yyyy")){
        today = true;
        thisWeek = true;
